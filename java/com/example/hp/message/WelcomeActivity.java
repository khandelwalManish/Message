...
public class WelcomeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (new com.example.hp.message.PreferenceManager(this).checkPreference())
            loadHome();
        ...
        BnSkip = findViewById(R.id.bn_skip);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.bn_skip:
                loadHome();
                new com.example.hp.message.PreferenceManager(this).writePreference();
                break;
        }
    }
